...
namespace SimpleScript.Tests
{
    public class BinderTests
    {
        ...
        public static IEnumerable<object[]> Data()
        {
            ...
            yield return new object[] { "Use_of_unset_variable_in_string", File.ReadAllText("TestData\\Inputs\\Use_of_unset_variable_in_string.txt"), new Errors(ErrorKind.ReferenceToUninitializedVariable) };
            yield return new object[] { "Use_of_unset_variable", File.ReadAllText("TestData\\Inputs\\Use_of_unset_variable.txt"), new Errors(ErrorKind.ReferenceToUninitializedVariable) };
        }
    }
}